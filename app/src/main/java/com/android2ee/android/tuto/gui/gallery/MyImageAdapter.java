...
public class MyImageAdapter extends BaseAdapter {
	...
	private final Integer[] mThumbIds = { R.drawable.ic_android2ee_blc, R.drawable.ic_android2ee_bleu,
			R.drawable.ic_android2ee_orange, R.drawable.ic_android2ee_violet, R.drawable.ic_android2ee_blc_inv,
			R.drawable.ic_android2ee_bleu_inv, R.drawable.ic_android2ee_orange_inv, R.drawable.ic_android2ee_violet_inv };
	...
	public long getItemId(int position) {
		...
		// The itemId is in fact the URI id of the item when you are using database or
		// ContentProvider
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Log.e("tag", "getViewCalled");
		// When using a Gallery convertView==null what ever happens
